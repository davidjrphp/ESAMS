        ...
        <div class="music-carousel-container">
            ...
            <div class="music-carousel">
                ...
                ?>
                    ...
                    $count++;
                    if ($count == 3) {
                        // Display only three items per scroll
                        break;
                    }
                    ?>
                <?php endwhile; ?>
...
<script>
    ...
    // Set the scroll amount in pixels (adjust as needed)
    var scrollAmount = 390; // You can adjust this value to match the width of your music items

    // Bind scroll buttons (left and right) to scroll the carousel
    $("#scroll-left").click(function() {
        $(".music-carousel").animate({
